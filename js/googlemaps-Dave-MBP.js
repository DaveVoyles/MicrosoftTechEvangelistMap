$(function () {
    ...
    function initialize() {
        ...
        function loopThroughAll(parameters) {
            ...
            for (var i = 0; i < evangelists.length; i++) {
                ...
                if (specSplit.toLowerCase == searchTermText.toLowerCase) {
                    console.log(specSplit.toLowerCase);
                    console.log(searchTermText.toLowerCase);
